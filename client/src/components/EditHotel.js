...
const EditHotel = ({match}) => {
  ...
  const handleImageChange = (e) => {
    ...
    const loadSellerHotel=async()=>{
        ...
        setAirConditioned(res.data.airConditioned)
        setPetsAllowed(res.data.petsAllowed)
    }
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                ...
                >
                  ...
                  <Option value="No">Wifi Not Available</Option>
                </Select>
                <Select
                 className="w-100 m-2"
                 size="large"
                ...
                >
                  <Option value="Yes">Air Condition Available </Option>
